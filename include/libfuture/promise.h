...
struct LIBFUTURE_API promise_impl_t
{
...
template <typename _Ty>
struct LIBFUTURE_API promise_t : public promise_impl_t<_Ty>
{
...
template <>
struct LIBFUTURE_API promise_t<void> : public promise_impl_t<void>
{
